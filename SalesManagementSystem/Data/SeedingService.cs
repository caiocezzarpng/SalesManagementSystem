...
namespace SalesManagementSystem.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller( "W Lenin", "wlenin@urss.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller("K Marx", "kmarx@manifesto.com", new DateTime(1998, 4, 21), 1000.0, d2);
            Seller s3 = new Seller("C Marighela", "cmariga@luta.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s4 = new Seller("L C Prestes", "lcprestes@pcb.com", new DateTime(1998, 4, 21), 1000.0, d4);
            Seller s5 = new Seller("Rosa Luxemburgo", "rosaluxemburgo@urss.com", new DateTime(1998, 4, 21), 1000.0, d3);
            Seller s6 = new Seller("Olga Benario", "obenario@revolucao.com", new DateTime(1998, 4, 21), 1000.0, d2);
